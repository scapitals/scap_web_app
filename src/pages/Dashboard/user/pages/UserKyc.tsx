  ...
  return (
    <div className="container py-8">
         <div className="flex justify-center items-center">
          <div className="flex flex-col justify-center items-center w-1/2 gap-4 text-center">
        ...
        <Link to="/user/kyc-data">
          <button className="p-2 rounded bg-primary">Click here for Verification</button>
        </Link>
