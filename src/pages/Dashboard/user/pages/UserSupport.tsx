...
const handleSubmit = async (e: any) => {
    ...
    //   const supData = {subject, message, category, userid};
  ...
  return (
    <div className='container py-6'>
        ...
        <div className="w-full">
            <form className="w-full border border-primary p-4 rounded-lg shadow-lg flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="">Message</label>
                    <textarea name="" id="" value={message} cols={30} rows={10} className='w-full border border-primary rounded' onChange={(e) => setMessage(e.target.value)}></textarea>
                </div>
