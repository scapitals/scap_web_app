        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-6">
            <div>
              ...
              <p className="text-lg md:text-3xl">INVESTOR RELATIONS</p>
          ...
          <div className="flex flex-col gap-6">
            <div>
              {/* <div className="bg-primary w-8 h-8 rounded-full"></div> */}
              <p className="text-lg md:text-3xl ">OUR DIVERSITY & INCLUSION STRATEGY</p>
              <hr className="w-32 md:w-64 h-1 dark:bg-[#f1f1f1] bg-[#1f2937]"/>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-10 justify-center items-center">
        ...
        <div>
          <div>
            ...
            <Button btntext="Learn More" btnlink="service"/> 
            </div>
        </div>
      </div>
    </div>
