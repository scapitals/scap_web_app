  ...
  return (
    ...
    <div className=' bg-green-300'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 py-12'>
            ...
            <div className='flex flex-col gap-6'>
                <h2>A PLAN THAT PUTS THE BEST FINANCIAL CHOICES IN YOUR HANDS</h2>
    ...
    <div className='container'>
        ...
        <div className='flex flex-col justify-center items-center'>
            <div className='w-1/2'>
                <p>OUR VERSION OF FINANCIAL PLANNING</p>
                <p>Some companies only focus on insurance, Others on investments. Our advisors look at your financial big picture and recommend the right insurance and investment strategies in one integrated financial plan, designed to help you live the life you've always wanted.</p>
            </div>
        </div>     
